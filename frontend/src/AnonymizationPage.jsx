                        ...
                        {columns.map((col) => (
                            <div key={col}>
                                ...
                                >
                                    ...
                                    <option value="date_naissance">Date de naissance (Généralisation par intervalle)
                                    </option>
                                    <option value="date">Date</option>
                                    <option value="ville">Ville</option>
                                    <option value="adresse">Adresse</option>
                                    <option value="solde">Solde bancaire</option>
                                    <option value="chiffre">Chiffre</option>
                                    <option value="carte_bancaire">Numéro de carte bancaire</option>
                                    {/* Ajout du type "Carte bancaire" */}
