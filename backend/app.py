...
#fonction pour généraliser les dates en intervalles
...
#fonction pour généraliser les valeurs numériques en intervalles
    ...
    for column in df.columns:
        ...
        if column_type:
            if column_type == 'name':
                ...
                df[column] = df[column].apply(generalize_generic_date)
